...
for index, force in pairs(game.forces) do
  ...
  if force.technologies["useful-combinators"].researched then
    ...
    force.recipes["emitter-combinator"].enabled = true
    force.recipes["receiver-combinator"].enabled = true
    force.recipes["power-combinator"].enabled = true
    force.recipes["daytime-combinator"].enabled = true
    force.recipes["pollution-combinator"].enabled = true
    force.recipes["statistic-combinator"].enabled = true
  end
end